...
public class Drivetrain implements Behavior {
	...
	public void update() {
		...
		sharedOutputValues.setNumeric("opn_drivetrain_front_left_speed","percent", driveAxis);		sharedOutputValues.setNumeric("opn_drivetrain_front_right_speed","percent", driveAxis);
